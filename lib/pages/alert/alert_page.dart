...
class _AlertsPageState extends State<AlertsPage> {
  ...
  PreferredSizeWidget _appBar(BuildContext context) {
    return AppBar(
      backgroundColor: const Color.fromARGB(255, 243, 232, 111),
      ...
      title: Text(
        ...
        style: Theme.of(context)
            .textTheme
            .headline5
            ?.copyWith(color: Color.fromARGB(255, 61, 3, 3)),
      ),
    );
  }
                      ...
                      child: Row(
                        children: [
                          IconButton(
                            ...
                            icon: const Icon(
                              Icons.remove,
                              color: Color.fromARGB(255, 243, 232, 111),
                            ),
                          ),
              ...
              return AnimatedSwitcherWrapper(
                child: Text(
                  ...
                  style: const TextStyle(
                    ...
                    color: Color.fromARGB(255, 70, 65, 3),
                  ),
                ),
              );
            })
          ...
          child: ElevatedButton(
            ...
            style: ButtonStyle(
              backgroundColor: MaterialStateProperty.all(
                  const Color.fromARGB(255, 243, 232, 111)),
            ),
            child: const Text(
              "Buy Now",
              style: TextStyle(
                color: Color.fromARGB(255, 70, 2, 2),
                fontSize: 15,
